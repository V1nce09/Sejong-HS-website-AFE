...
# 로그인 사용자는 계정별, 비로그인 사용자는 IP별로 제한합니다.
# 학교에서는 여러 학생이 같은 공인 IP를 공유하므로 로그인 사용자를 IP로 묶지 않습니다.
USER_REQUESTS_PER_MINUTE = int(os.getenv("USER_REQUESTS_PER_MINUTE", "240"))
USER_API_REQUESTS_PER_MINUTE = int(os.getenv("USER_API_REQUESTS_PER_MINUTE", "120"))
USER_MUTATIONS_PER_MINUTE = int(os.getenv("USER_MUTATIONS_PER_MINUTE", "60"))
ANON_REQUESTS_PER_MINUTE = int(os.getenv("ANON_REQUESTS_PER_MINUTE", "90"))
ANON_API_REQUESTS_PER_MINUTE = int(os.getenv("ANON_API_REQUESTS_PER_MINUTE", "45"))
ANON_MUTATIONS_PER_MINUTE = int(os.getenv("ANON_MUTATIONS_PER_MINUTE", "15"))
# 구버전 환경변수와의 호환을 위해 이름은 남겨둡니다.
REQUESTS_PER_MINUTE = int(os.getenv("REQUESTS_PER_MINUTE", str(ANON_REQUESTS_PER_MINUTE)))
POSTS_PER_MINUTE = int(os.getenv("POSTS_PER_MINUTE", str(ANON_MUTATIONS_PER_MINUTE)))
API_REQUESTS_PER_MINUTE = int(os.getenv("API_REQUESTS_PER_MINUTE", str(ANON_API_REQUESTS_PER_MINUTE)))
RATE_BLOCK_SECONDS = int(os.getenv("RATE_BLOCK_SECONDS", "60"))
SECURITY_EVENT_WINDOW_SECONDS = int(os.getenv("SECURITY_EVENT_WINDOW_SECONDS", "600"))
SECURITY_EVENT_BLACKLIST_THRESHOLD = int(os.getenv("SECURITY_EVENT_BLACKLIST_THRESHOLD", "8"))
